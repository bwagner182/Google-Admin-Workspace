...
def print_help():
    ...
    print("")
    print("new employee")
    print("This will allow for inputs to create user accounts across all")
    print("platforms\n")
    print("term employee")
    print("This will change the user's password in Google, and update their")
    print("loan in Reftab to show that it needs to be shipped home\n")
    print("test")
