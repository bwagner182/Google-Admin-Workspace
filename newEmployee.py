...
SCOPES = [
			...
			'https://apps-apis.google.com/a/feeds/userinfo['groups']/',
...
def create_user_reftab(userinfo):
	...
	result = client.post('loanees', body)

	if result['lnid'] && result['lnid'] != '':
...
def main():
	...
	gresp = create_user_google(userinfo)
	mosyle_resp = create_user_mosyle(userinfo)
	reftab_resp = create_user_reftab(userinfo)
